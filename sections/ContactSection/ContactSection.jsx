      ...
      <div className="c-contact-section">
        ...
        <div className="c-contact-section__desc">
          <img
            src={CatBorgir}
            alt="CatBorgir"
            className="c-cat-borgir waffle-float"
          />
          <div className="c-contact-section__info">
            <p className="c-contact-section__text">
              do you need a UI/UX Designer or a front-end web developer? contact
              me!
            </p>
            <div className="c-contact-section__details">
              <div>
                ...
                <div>
                  <p>Email</p>
                  <a
                    href="mailto:donnahopebersabebanzuela@gmail.com"
                    className="c-contact__email"
                  >
                    donnahopebersabebanzuela@gmail.com
                  </a>
                </div>
              </div>
              <div>
          ...
          <nav className="c-contact-setion__social-media">
            <a
              href="https://www.linkedin.com/in/donna-hope-banzuela-34a470323/"
              target="_blank"
            >
            ...
            <a
              href="https://www.facebook.com/donna.hope.117077"
              target="_blank"
            >
