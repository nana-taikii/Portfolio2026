  ...
  return (
     <div className = 'c-about-folder-content c-about-desc'>
      <div className = 'c-about-folder-content__desc'>
                ...
                <div>
                    <p>
                       Im a ui/ux developer and designer in this year. But I also had accepted projects as a wordpress developer from a japanese client and a graphic designer for a california based company since <span class = 'c-about-desc__highlight'>2025</span>.
                    </p>
